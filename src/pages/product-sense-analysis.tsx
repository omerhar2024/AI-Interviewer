...
export default function ProductSenseAnalysisPage() {
  ...
  // Determine which framework was used based on response notes
  const determineFramework = () => {
    if (!response || !response.notes) return "generic";
    return response.notes.framework || "generic";
  };
  ...
  return (
    <div className="w-full p-6 mx-auto max-w-7xl">
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-3xl font-bold">Product Sense Analysis</h1>
      </div>
