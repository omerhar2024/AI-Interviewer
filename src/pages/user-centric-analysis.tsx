...
export default function UserCentricAnalysisPage() {
  ...
  return (
    <div className="w-full p-6 mx-auto max-w-7xl">
      <div className="flex items-center mb-8">
        ...
        <h1 className="text-4xl font-bold">User-Centric Design Analysis</h1>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Question and Response Section */}
        <div className="space-y-6">
          <Card className="p-6 bg-gradient-to-br from-orange-50 to-white rounded-xl shadow-lg border border-orange-100">
            ...
            <div className="mt-4 p-3 bg-orange-100 rounded-lg">
              <p className="text-sm font-medium text-orange-800">
                Framework Used: User-Centric Design
              </p>
            </div>
          </Card>
        ...
        <div className="space-y-6">
          <Card className="p-6 bg-gradient-to-br from-orange-50 to-white rounded-xl shadow-lg border border-orange-100">
            ...
            <div className="bg-white p-4 rounded-md border border-orange-100 whitespace-pre-line overflow-auto max-h-[600px]">
